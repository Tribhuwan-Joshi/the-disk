    ...
    while True:
        try:
            ...
            while recorder.recording:
                # Waiting for the recording to stop automatically after silence
                pass
            ...
            response = client.chat.completions.create(
                model="gpt-4",
                messages=[
                    {"role": "system", "content": "You are a helpful assistant built by Deepware. Your name is The Disk. Always answer to the point and as brief as possible. Try to keep the conversation continue by asking back question like human. Browse internet for current date and time."},
